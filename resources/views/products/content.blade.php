...
@section('content')
    ...
    <div class="container p-t-100">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="/danh-muc/{{$product->menu->id.'/'.$product->menu->slug}}.html"
                            ...
                            <div class="slick3 gallery-lb slick-initialized slick-slider slick-dotted">
                                <div class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 1539px;">
                                        ...
                                        {{--                                            </div>--}}
                                        {{--                                        </div>--}}
                                        {{--                                        <div class="item-slick3 slick-slide" data-thumb="images/product-detail-03.jpg" data-slick-index="2" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide12" aria-describedby="slick-slide-control12" style="width: 513px; position: relative; left: -1026px; top: 0px; z-index: 998; opacity: 0;">--}}
                                        {{--                                            <div class="wrap-pic-w pos-relative">--}}
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <div class="p-t-33">
                            ...
                            {{--                                                       dir="ltr" style="width: 141.2px;"><span class="selection"><span--}}
                            {{--                                                    class="select2-selection select2-selection--single" role="combobox"--}}
                            {{--                                                    aria-haspopup="true" aria-expanded="false" tabindex="0"--}}
                            {{--                                                    aria-labelledby="select2-time-th-container"><span--}}
                            {{--                                                        class="select2-selection__rendered"--}}
                            {{--                                                        id="select2-time-th-container" title="Choose an option">Choose an option</span><span--}}
                            ...
                            {{--                                                    class="select2-selection select2-selection--single" role="combobox"--}}
                            {{--                                                    aria-haspopup="true" aria-expanded="false" tabindex="0"--}}
                            {{--                                                    aria-labelledby="select2-time-cn-container"><span--}}
                            {{--                                                        class="select2-selection__rendered"--}}
                            {{--                                                        id="select2-time-cn-container" title="Choose an option">Choose an option</span><span--}}
                            {{--                                                        class="select2-selection__arrow" role="presentation"><b--}}
                            {{--                                                            role="presentation"></b></span></span></span><span--}}
                            {{--                                                class="dropdown-wrapper" aria-hidden="true"></span></span>--}}
                            {{--                                        <div class="dropDownSelect2"></div>--}}
                    ...
                    <div class="slick-list draggable">
                        <div class="slick-track"
                            ...
                            @foreach($relateds as $related)
                                <div
                                    class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15 slick-slide slick-current slick-active"
                                    data-slick-index="0" aria-hidden="false" tabindex="0" style="width: 300px;">
                                    <!-- Block2 -->
                                    <div class="block2">
                                        <div class="block2-pic hov-img0">
                                            <img src="{{$related->thumb}}" alt=" {{$product->name}}">

                                            <a href="/san-pham/{{$related->id.'/'.$related->slug}}.html"
										...
										{!! \App\Helpers\Helper::price($related->price_sale) !!}
									</span>
                                            </div>
