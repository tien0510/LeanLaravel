...
{{--{{dd($products)}}--}}
    <form class="bg0 p-t-130 p-b-85" method="post">
            ...
            <div class="container">
                <div class="row">
                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    @foreach($products as $product)
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-5">$ {{number_format($priceEnd)}}</td>
                                            <td class="p-r-15" >

                                                <a class="btn btn-danger btn-sm" href=""
                                                   onclick="removeRow({{ $product->id }},'/carts/delete')">
                                                   Xoá
                                                </a>
                                            </td>
                                        </tr>
                    ...
                    <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15q-sm">
                            <h4 class="mtext-110 cl2 p-b-30" style="font-family: Roboto">
                                Đặt Hàng
                            </h4>
                            <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                                ...
                                <div class="size-209 p-r-18 p-r-0-sm w-full-ssm" style="width: 100%">
									...
									<span class="stext-112 cl8">
                                        ...
                                        <div class="bor8 bg0 m-b-12">
                                            <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="number" name="phone" placeholder="Số điện thoại">
                                        </div>
                                        <div class="bor8 bg0 m-b-12">
                                        ...
                                        <div class="bor8 bg0 m-b-12">
                                            <textarea class="stext-111 cl8 plh3 size-111 p-lr-15"  name="content" >Ghi Chú</textarea>
                                        </div>
        ...
        @else
            <div class="text-center"> Giỏ Hàng Đang Trống Mua Sắm Ngay Nào ♥ </div>
        @endif
    </form>
